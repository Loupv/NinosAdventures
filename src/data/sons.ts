...
export const SONS: Son[] = [
  ...
  },
  {
    ...
    present: true,
    provisoire: true,
    quand: 'La Tour de Bretagne, du pied au toit — la nuit est tombée et personne ne devrait être là.',
    variantes: 1,
    cherche:
      'Un peu inquiétante, sans faire peur : trente-deux étages de nuit. Le fichier posé : « Rumble at the Gates » (Abstraction, CC0) ralentie de moitié, une octave sous l’original.',
    priorite: 'plus tard',
    boucle: true,
  },
  {
...
const MUSIQUE_PAR_PIECE: Record<string, string> = {
  ...
  ecole: 'musique-ville',
  // La tour a sa musique à elle, du pied au toit : la ville s'arrête à sa porte.
  'tour-pied': 'musique-tour',
  'tour-hall': 'musique-tour',
  'tour-13': 'musique-tour',
  'tour-27': 'musique-tour',
  'tour-31': 'musique-tour',
  'tour-toit': 'musique-tour',
  bars: 'musique-ville',
